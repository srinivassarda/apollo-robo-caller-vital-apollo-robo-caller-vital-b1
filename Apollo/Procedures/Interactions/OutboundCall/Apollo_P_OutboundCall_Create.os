<OpenSpanDesignDocument Version="8.0.1026.0" Serializer="2.0" Culture="en-US">
  ...
  <Component Version="1.0">
    <OpenSpan.Automation.Automator Name="Apollo_P_OutboundCall_Create" Id="Automator-8D5B646C8B063C7">
      <AutomationDocument>
        <Name Value="" />
        ...
        <Links>
          ...
          <DecisionEventLink PartID="65" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <LinkPoints>
              ...
              <Point value="996, 697" />
              <Point value="996, 697" />
              <Point value="1084, 697" />
              <Point value="1084, 740" />
              <Point value="772, 740" />
              <Point value="772, 649" />
              <Point value="955, 649" />
              <Point value="965, 649" />
          ...
          <Link PartID="87" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <LinkPoints>
              <Point value="1068, 649" />
              <Point value="1078, 649" />
              <Point value="1078, 649" />
              <Point value="1078, 649" />
          ...
          <Link PartID="90" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <LinkPoints>
              <Point value="1068, 666" />
              <Point value="1078, 666" />
              <Point value="1084, 666" />
              <Point value="1084, 709" />
              <Point value="1135, 709" />
              <Point value="1145, 709" />
            </LinkPoints>
          </Link>
    ...
    <OpenSpan.Automation.WaitForEvent Name="waitForEvent1" Id="WaitForEvent-8D5B64AB2A568DC">
      <ComponentName Value="chkWarmTransfer" />
      <DisplayName Value="_HIPAA_chkWarmTransfer.Created" />
      <ExceptionsHandled Value="False" />
    ...
    <OpenSpan.Automation.ConnectableMethod Name="connectableMethod9" Id="ConnectableMethod-8D5B64B09FB4C0A">
      <ComponentName Value="cmbReasons" />
      <DisplayName Value="SelectItemByText" />
      <ExceptionsHandled Value="False" />
